...
namespace MedLab.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LabAssistantId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LabAssistantName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LabAssistants", x => x.LabAssistantId);
                    table.ForeignKey(
                        name: "FK_LabAssistants_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_LabAssistants_LabAssistantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_LabAssistantId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LabAssistants_DepartmentId",
                table: "LabAssistants",
                column: "DepartmentId");
