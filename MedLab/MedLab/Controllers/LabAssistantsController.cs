...
namespace MedLab.Controllers
{
    public class LabAssistantsController : Controller
    {
        ...
        public LabAssistantsController(MedLabDbContext context)
        {
            _context = context;
        }
        ...
        {
            var medLabDbContext = _context.LabAssistants.Include(l => l.Department);
        ...
        public async Task<IActionResult> Create([Bind("LabAssistantId,LabAssistantName,DepartmentId")] LabAssistant labAssistant)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "DepartmentId", "DepartmentName", labAssistant.DepartmentId);
            return View(labAssistant);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LabAssistantId,LabAssistantName,DepartmentId")] LabAssistant labAssistant)
        {
